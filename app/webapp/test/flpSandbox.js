		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Business Partner Browser",
									"targetURL": "#dsagdebupabrowser-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dsagdebupabrowser-display": {
								"semanticObject": "dsagdebupabrowser",
								"action": "display",
								"description": "Business Partner Browser",
								"title": "Business Partner Browser",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dsag.de.bupabrowser",
									"url": sap.ui.require.toUrl("dsag/de/bupabrowser")
								}
							}
						}
					}
